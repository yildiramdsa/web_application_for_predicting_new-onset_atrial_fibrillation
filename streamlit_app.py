...
def render_form():
    with st.form(key=st.session_state["form_key"], clear_on_submit=False):
        ...
        st.write("_Select all that apply: Noted at any time prior to or 6 months after the index ECG_")
        c1, c2, c3 = st.columns(3)
        ...
        st.write("_Select all that apply: Noted at any time prior to the index ECG_")
        ...
        st.write("Enter all available values for tests: Taken within 1 year prior to or 6 months after the index ECG.")
        ...
        st.write("Enter all the values for tests: Taken within 3 years prior to or 1 year after the date of index of 12-lead ECG.")
        ...
        st.write("_Select all medication: Taken within 90 days prior to or after the date of index of 12 lead ECG_")  
